...
export async function syncSpendingLotsFromSummary(projectId, summary, lots) {
    ...
    for (const entry of summaryEntries) {
        ...
        else if (lot.name !== entry.lot.trim() ||
